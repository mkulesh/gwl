...
public:
    ...
    typedef enum
    {
        UNDEF, AXIS, SIGD, SIGC, SIGE2D, SIGE3D, SPECD, SPECC, SPECE2D, SPECE3D
    } ObjectType;
...
public:
    ...
    inline ObjectType getType (void)
    {
        return _type;
    }
    ...
    PPPBaseObject *read (const char *aName)
    {
        ...
        case AXIS:
            ...
            break;
        case SIGD:
            aDest = new PPPSignalContainer<double>;
            break;
        case SIGC:
            aDest = new PPPSignalContainer<PPPcomplex>;
            break;
        case SIGE2D:
            aDest = new PPPSignalContainer<PPPellipse2D>;
            break;
        case SIGE3D:
            aDest = new PPPSignalContainer<PPPellipse3D>;
            break;
        case SPECD:
            aDest = new PPPSpectrContainer<double>;
            break;
        case SPECC:
            aDest = new PPPSpectrContainer<PPPcomplex>;
            break;
        case SPECE2D:
            aDest = new PPPSpectrContainer<PPPellipse2D>;
            break;
        case SPECE3D:
            aDest = new PPPSpectrContainer<PPPellipse3D>;
            break;
        }
        if (aDest != NULL)
        {
