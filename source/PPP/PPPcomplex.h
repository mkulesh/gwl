...
public:
    ...
    PPPcomplexArgFilter (const double aMax, const double aPer, const double aDefaultval = -M_PI,
                         bool aDegree = false)
    {
        maxmodulus = aMax;
        percent = aPer;
