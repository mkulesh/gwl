...
public:
    ...
    PPPOptiSignal () :
            _propType(PPPPropagatorDiss::STfour)
    {
    ...
    void prepare (PPPSignalContainer<double> &aSource, PPPDispersionModel &aModel, double aDist,
                  PPPPropagatorDiss::PropType aPropType, unsigned aChan1 = 0, unsigned aChan2 = 1)
    {
        ...
        ATypeOpti::evalFixed((getWn().getType() == PPPApproximate::APTpolin), false,
                             getWn().size());
    }
