...
public:
    ...
    {
        strstream str;
        str << "Func(f) = sum((a[i]*Bispline(3.0+(f-_xmin-i*dF)/dF), i=0..." << (size() - 1)
        << endl;
...
private:
    ...
    double bsp4 (double b)
    {
        ...
        if (b >= 0.0 && b <= 1.0)
            ...
            res = (-3.0 * b * b * b + 12.0 * b * b - 12.0 * b + 4.0) / 6.0;
        else if (b >= 2.0 && b <= 3.0)
            res = (3.0 * b * b * b - 24.0 * b * b + 60.0 * b - 44.0) / 6.0;
        else if (b >= 3.0 && b <= 4.0)
            res = (4.0 - b) * (4.0 - b) * (4.0 - b) / 6.0;
        else
            res = 0.0;
        return 1.5 * res;
    }
    ...
    double bsp4prim (double b)
    {
        ...
        if (b >= 0.0 && b <= 1.0)
            ...
            res = (-9.0 * b * b + 24.0 * b - 12.0) / 6.0;
        else if (b >= 2.0 && b <= 3.0)
            res = (9.0 * b * b - 48.0 * b + 60.0) / 6.0;
        else if (b >= 3.0 && b <= 4.0)
            res = -3.0 * (4.0 - b) * (4.0 - b) / 6.0;
        else
            res = 0.0;
        return 1.5 * res;
    }
