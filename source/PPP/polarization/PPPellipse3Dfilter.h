...
public:
    ...
    PPPEllipse3Dfilter (FilterType aType, double aTilt, double aRatio, double aInt1 = 0.0,
                        double aInt2 = 0.0)
    {
    ...
    friend ostream& operator << (ostream& aDest, FilterType aSour)
    {
        switch (aSour)
        {
        case PPPEllipse3Dfilter::NRFLinXY:
            aDest << PPELLIPSE3DFILTER_LINXY;
            break;
        case PPPEllipse3Dfilter::NRFLinXZ:
            aDest << PPELLIPSE3DFILTER_LINXZ;
            break;
        case PPPEllipse3Dfilter::NRFLinYZ:
            aDest << PPELLIPSE3DFILTER_LINYZ;
            break;
        case PPPEllipse3Dfilter::NRFElliXY:
            aDest << PPELLIPSE3DFILTER_ELLIXY;
            break;
        case PPPEllipse3Dfilter::NRFElliXZ:
            aDest << PPELLIPSE3DFILTER_ELLIXZ;
            break;
        case PPPEllipse3Dfilter::NRFElliYZ:
            aDest << PPELLIPSE3DFILTER_ELLIYZ;
            break;
        case PPPEllipse3Dfilter::NRFNorm:
            aDest << PPELLIPSE3DFILTER_NORMTA;
            break;
        case PPPEllipse3Dfilter::NRFprog:
            aDest << PPELLIPSE3DFILTER_PROGRADE;
            break;
        case PPPEllipse3Dfilter::NRFretro:
            aDest << PPELLIPSE3DFILTER_RETROGRADE;
            break;
        case PPPEllipse3Dfilter::NRFlin:
            aDest << PPELLIPSE3DFILTER_LIN;
            break;
        case PPPEllipse3Dfilter::NRFelli:
            aDest << PPELLIPSE3DFILTER_ELLI;
            break;
        case PPPEllipse3Dfilter::NRFazimuth:
            aDest << PPELLIPSE3DFILTER_AZIMUTH;
            break;
        case PPPEllipse3Dfilter::NRFdip:
            aDest << PPELLIPSE3DFILTER_DIP;
            break;
        }
        return aDest;
    }
    ...
    const char *getInfo (void)
    {
        ...
        else if (getType() == NRFLinXY || getType() == NRFLinXZ || getType() == NRFLinYZ
                 || getType() == NRFElliXY || getType() == NRFElliXZ || getType() == NRFElliYZ)
            str << ": " << PPELLIPSE3DFILTER_NANGL << "=" << getTilt() << ", " << PPPELLIPSE_RATIO
            << "=" << getRatio();
        else if (getType() == NRFazimuth || getType() == NRFdip || getType() == NRFprog
                 || getType() == NRFretro) str << ": " << PPELLIPSE3DFILTER_AZINT << "=["
                                           << getInt1() << ", " << getInt2() << "]";
        str << ends;
        onNotation(str.str());
        return getNotation();
    ...
    inline double getInt1 ()
    {
        return _int1;
    }
    
    inline double getInt2 ()
    {
        return _int2;
    }
    ...
    bool isContent (PPPellipse3D &aVal)
    {
        ...
        case NRFLinXY:
        case NRFElliXY:
            tilt = _compPlancosz(aVal);
            break;
        case NRFLinXZ:
        case NRFElliXZ:
            tilt = _compPlancosy(aVal);
            break;
        case NRFLinYZ:
        case NRFElliYZ:
            tilt = _compPlancosx(aVal);
            break;
        }
        switch (getType())
        {
        case NRFlin:
        case NRFelli:
            if ((getType() == NRFlin && ratio >= getRatio()) || (getType() == NRFelli
                    && ratio < getRatio())) return false;
            break;
        case NRFLinXY:
        case NRFLinXZ:
        case NRFLinYZ:
        ...
        case NRFretro:
            ...
            if (((getType() == NRFprog && sratio < 0.0) || (getType() == NRFretro && sratio > 0.0)) || (ratio
                    < getInt1()
                                                                                                        || ratio > getInt2())) return false;
            break;
        case NRFazimuth:
