...
public:
    ...
    {
        if (isDegree)
            return (180.0 * aVal.tilt_rmax() / M_PI);
        else
            return aVal.tilt_rmax();
    }
    ...
    inline const char *getComponentName (void) const
    {
        return PPPELLIPSE_TILT;
    }
    
    inline const char *getComponentCode (void) const
    {
        return PPPELLIPSE_CODETILT;
    }
...
public:
    ...
    {
        if (isDegree)
            return (180.0 * aVal.phasediff() / M_PI);
        else
            return aVal.phasediff();
    }
    ...
    inline const char *getComponentName (void) const
    {
        return PPPELLIPSE_PHDIFF;
    }
    
    inline const char *getComponentCode (void) const
    {
        return PPPELLIPSE_CODEPHDIFF;
    }
...
public:
    ...
    inline const char *getComponentName (void) const
    {
        return PPPELLIPSE_PHASE1;
    }
    
    inline const char *getComponentCode (void) const
    {
        return PPPELLIPSE_CODEPHASE1;
    }
...
public:
    ...
    inline const char *getComponentName (void) const
    {
        return PPPELLIPSE_PHASE2;
    }
    
    inline const char *getComponentCode (void) const
    {
        return PPPELLIPSE_CODEPHASE2;
    }
