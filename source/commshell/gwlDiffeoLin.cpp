...
public:
    ...
    gwlMain (const char *aAppName, const char *aModName, const char *aDefIn, const char *aDefOut) :
            gwlMainObject<PPPSpectrContainer<PPPcomplex>, PPPSpectrContainer<PPPcomplex> >(aAppName,
                                                                                           aModName,
                                                                                           aDefIn,
                                                                                           aDefOut),
            o_name("n", "name", "<str>",
                   "name of deformed spectrum (by default 'wavelet spectrum after diffeomorphism')",
