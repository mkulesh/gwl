...
template<class ATypeMain> class gwlMain : public ATypeMain
  ...
  public:
    ...
    gwlMain(const char *aAppName, const char *aModName, const char *aDefIn, const char *aDefOut):
      ...
      o_type   ("y", "type",    "<str>", "type of the elliptic mashine: morozov, scovar, acovar (by default 'acovar')", "acovar"),
    ...
    void calc(PPPSpectrContainer<PPPellipse3D> &aLocDest, PPPSpectrContainer<PPPcomplex> &aLocSource) {
      if(aTrans.getMachine() == WTEMorozov)
